...
const ProjectItem = ( { image, alt, titulo, descricao, stack, link } ) => {
  return (
    <a href='#' className='relative w-[90%] m-auto sm:mb-[100px] h-[250px] sm:h-[40%] items-center group hover:mb-[64px] hover:sm:mb-[15%] flex flex-col justify-center hover:sm:flex-row hover:justify-between hover:scale-110 duration-200'>
        ...
        <div className='relative w-[75%] h-[60%] sm:w-[50%] sm:h-[90%] invisible group-hover:visible m-auto p-1 sm:p-2 bg-slate-400 rounded-lg'>
            ...
            <div className='absolute invisible group-hover:visible group-hover:mb-[50px] group-hover:sm:mb-[0px] w-full h-[15%] m-auto ml-[-5px] mt-[17.5px] sm:ml-[-8px] sm:mt-[24px] bg-slate-400 rounded-lg p-1'>
                <p className='font-extralight font-montserrat md:text-sm text-xs text-slate-600 text-center group-hover:[font-size:10px] group-hover:sm:[font-size:14px]'>{stack}</p>
            </div>
        </div>
    </a>
  )
