...
const ProjectItem = ( { image, alt, titulo, descricao, stack, link } ) => {
  return (
    <a href='#projects' className='relative w-[90%] m-auto sm:mb-[100px] h-[250px] sm:h-[40%] items-center group hover:mb-[64px] hover:sm:mb-[15%] flex flex-col justify-center hover:sm:flex-row hover:justify-between hover:scale-110'>
