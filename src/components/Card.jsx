...
const Card = () => {
    ...
    <div className='m-auto w-full mt-[10%] sm:h-[50%] relative items-center justify-center flex-col sm:flex-row flex sm:justify-between'>
        <div className='group relative w-full h-full mx-5 my-2 '>
            <div className='relative m-auto min-w-[180px] min-h-[260px] w-[80%] sm:w-full sm:h-full rounded-xl shadow-lg transition-all duration-1000 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]'>
                <div className='m-auto sm:w-full sm:h-full absolute rounded-xl shadow-pink-200 shadow-lg border border-gray-700 inset-0 hover:cursor-pointer bg-slate-400 [transform:rotateY(180deg)]'>
                    <img src={person} className='h-full w-full rounded-xl object-cover shadow-lg' alt="" />
                </div>
                <div className='m-auto py-1 px-2 sm:w-full sm:h-full absolute rounded-xl shadow-slate-200 shadow-lg border border-gray-700 inset-0 hover:cursor-pointer bg-pink-200 [backface-visibility:hidden] [transform:rotateY(180deg)]'>
        ...
        <div className='group relative w-full h-full mx-5 my-2'>
            <div className='relative m-auto min-w-[180px] min-h-[260px] w-[80%] sm:w-full sm:h-full rounded-xl shadow-lg transition-all duration-1000 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]'>
                <div className='m-auto absolute rounded-xl shadow-pink-200 shadow-lg border border-gray-700 inset-0 hover:cursor-pointer bg-slate-400 [transform:rotateY(180deg)]'>
                    <img src={laptop} className='h-full w-full rounded-xl object-cover shadow-lg' alt="" />
                </div>
                <div className='m-auto py-1 px-2 absolute rounded-xl shadow-slate-200 shadow-lg border border-gray-700 inset-0 hover:cursor-pointer bg-pink-200 [backface-visibility:hidden] [transform:rotateY(180deg)]'>
                    <div className='flex flex-col min-h-full items-center justify-center'>
        ...
        <div className='group relative w-full h-full mx-5 my-2'>
            <div className='relative m-auto min-w-[180px] min-h-[260px] w-[80%] sm:w-full sm:h-full rounded-xl shadow-xl transition-all duration-1000 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]'>
                ...
                <div className='m-auto py-1 px-2 absolute rounded-xl shadow-slate-200 shadow-xl border border-gray-700 inset-0 hover:cursor-pointer bg-pink-200 [backface-visibility:hidden] [transform:rotateY(180deg)]'>
                    <div className='flex flex-col min-h-full items-center justify-center'>
