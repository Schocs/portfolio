    ...
    <div>
      ...
      <div className='md:block hidden fixed top-[25%] z-10'>
        <div className='flex flex-col'>
          ...
          hover:scale-110 ease-in duration-500 hover:bg-pink-100 hover:w-[150%] group' >
            <AiOutlineHome size={20}/>
            <p className='invisible group-hover:visible absolute top-3 right-3 text-lg font-normal font-sans text-gray-900'>Menu</p>
          </a>
          ...
          hover:scale-110 ease-in duration-500 hover:bg-pink-100 hover:w-[160%] group'>
            <AiOutlineProject size={20}/>
